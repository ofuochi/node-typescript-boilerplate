...
let MovieController = class MovieController {
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._movieRepository.findAll();
        });
    }
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._movieRepository.findById(id);
        });
    }
    post(movieDto) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._movieRepository.save(movieDto);
        });
    }
};
__decorate([
...
], MovieController.prototype, "_movieRepository", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MovieController.prototype, "getById", null);
__decorate([
...
MovieController = __decorate([
    inversify_express_utils_1.controller("/api/movies")
], MovieController);
