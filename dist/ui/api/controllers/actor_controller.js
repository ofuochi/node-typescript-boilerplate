...
let ActorController = class ActorController {
    get() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._actorRepository.findAll();
        });
    }
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this._actorRepository.findById(id);
        });
    }
};
__decorate([
...
], ActorController.prototype, "_actorRepository", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ActorController.prototype, "getById", null);
ActorController = __decorate([
    inversify_express_utils_1.controller("/api/actors")
], ActorController);
